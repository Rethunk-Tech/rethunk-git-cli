...
func TestHelp_BareInvocationStillExitsInvalidUsage(t *testing.T) {
	...
	// seven subcommands (diff, commit, blame, log, languages, doctor,
	// completion) include no useful no-op mode, and every other usage error
	// in its table (missing message, no target, ...) is already
