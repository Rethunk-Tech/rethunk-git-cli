...
// the platform itself -- the POSIX shared, world-writable /tmp that
// owner_unix.go's own sameOwner defends against has no equivalent here for
// rgit to defend against the same way.
