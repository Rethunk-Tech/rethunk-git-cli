...
// rgitLanguagesFlags, rgitDoctorFlags, and rgitCompletionFlags are the same
// kind of static mirror as rgitDiffFlags/rgitCommitFlags above, for the
// three subcommands small enough that languages.go, doctor.go, and this
// file parse their own args by hand rather than building a pflag.FlagSet --
// completion previously offered none of them at all, since neither shell
// script's case statement had an entry for these commands.
