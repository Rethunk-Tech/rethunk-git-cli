...
const rgitSubcommands = "diff commit blame languages doctor completion help -h --help --version"
...
// rgitLanguagesFlags, rgitDoctorFlags, rgitCompletionFlags, and
// rgitBlameFlags are the same kind of static mirror as rgitDiffFlags/
// rgitCommitFlags above, for the subcommands small enough that
// languages.go, doctor.go, blame.go, and this file parse their own args by
// hand rather than building a pflag.FlagSet -- completion previously
// offered none of them at all, since neither shell script's case statement
// had an entry for these commands. TestCompletionFlags_MatchLiveFlagSets
// checks all of them against their own --help output the same way.
